**WARNING** : Steamware is about ready to go. There are some features that are not in yet (marked by a *) but its working good. You will happy with what we got so far I think. README.md for now is trash but this isnt my day job. Script is stable as far as I can tell but you could break it if you tried. Just a script not a library yet but check it out if you want. 
